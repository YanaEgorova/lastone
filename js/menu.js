...
function animateUpByLinks(currentSection) {
  ...
  // console.log('currentSection.nextElementSibling', currentSection.nextElementSibling);
...
function animateDownByLinks(currentSection) {
  ...
  // console.log('currentSection.previousElementSibling', currentSection.previousElementSibling);
